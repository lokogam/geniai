...
$string['noapikey'] = 'OpenAI API key has not been configured';
$string['openai_error'] = 'OpenAI Error: {$a}';
$string['invalid_response'] = 'Invalid response from OpenAI';
$string['creating_course'] = 'Creating course, please wait...';
$string['course_creation_failed'] = 'Failed to create course';

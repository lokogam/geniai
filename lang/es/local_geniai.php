...
$string['caseuse_balanced'] = 'Respuestas Equilibradas => Temperatura 0.5 - 0.7, Top_p 0.7';
...
$string['frequency_penalty_desc'] = 'Este parámetro se utiliza para desalentar al modelo a repetir las mismas palabras o frases con demasiada frecuencia en el texto generado. Es un valor agregado a la probabilidad logarítmica de un token cada vez que aparece en el texto generado. Una penalización de frecuencia más alta hará que el modelo sea más conservador al usar tokens repetidos.';
$string['geniai:manage'] = 'Administrar GeniAI';
...
$string['h5p-accordion-desc'] = 'Crea un Glosario que permita a los estudiantes acceder rápidamente a las respuestas sin sentirse abrumados por texto excesivo.';
$string['h5p-accordion-title'] = 'Glosario';
$string['h5p-advancedtext-desc'] = 'Crea un libro digital a partir de tu contenido, organizándolo en capítulos de manera lógica y atractiva para garantizar una división cohesiva y cautivadora del material.';
...
$string['h5p-crossword-desc'] = 'Crea un juego de crucigramas interactivo para involucrar a los estudiantes, utilizando palabras clave de tu contenido para promover un aprendizaje divertido y dinámico.';
$string['h5p-crossword-title'] = 'Crucigrama';
$string['h5p-delete-success'] = '¡H5P eliminado exitosamente!';
$string['h5p-dialogcards-desc'] = 'Crea tarjetas didácticas que actúan como ejercicios interactivos para ayudar a los estudiantes a memorizar palabras, frases o conceptos clave de los textos. En el frente de cada tarjeta hay una pista o indicio, y al voltearla, el estudiante revela la información correspondiente. Estas tarjetas pueden usarse en el aprendizaje de idiomas, resolución de problemas matemáticos o para ayudar a los estudiantes a memorizar datos importantes como eventos históricos, fórmulas o nombres.';
$string['h5p-dialogcards-title'] = 'Tarjetas Didácticas';
$string['h5p-dragtext-desc'] = 'Crea un juego de Arrastrar las Palabras donde el estudiante debe arrastrar la parte faltante del texto a su lugar correcto, formando una expresión completa. Este juego puede usarse para evaluar si el estudiante recuerda el contenido que leyó o comprende lo que se cubrió. Además, ayuda al estudiante a reflexionar más profundamente sobre el texto, promoviendo una mejor asimilación del contenido.';
$string['h5p-dragtext-title'] = 'Juego de Arrastrar las Palabras';
$string['h5p-example'] = 'Ver ejemplo';
$string['h5p-findthewords-desc'] = 'Crea un juego de sopa de letras donde los estudiantes deben encontrar y seleccionar palabras en una cuadrícula basándose en una lista proporcionada.';
$string['h5p-findthewords-title'] = 'Sopa de Letras';
$string['h5p-interactivebook-desc'] = 'Crea un Libro Interactivo que combine varios contenidos interactivos, como videos interactivos, glosarios, cuestionarios, actividades de arrastrar y soltar, crucigramas, sopas de letras y más, organizados en múltiples páginas. Añade un resumen al final, mostrando la puntuación total que el estudiante obtuvo a lo largo del libro.';
$string['h5p-interactivebook-title'] = 'Libro Interactivo';
$string['h5p-interactivevideo-desc'] = 'Crea un video interactivo con capítulos y un glosario destacando los puntos clave del contenido. Al final, añade un resumen interactivo para reforzar el aprendizaje y revisar los temas cubiertos.';
$string['h5p-interactivevideo-title'] = 'Video Interactivo';
$string['h5p-manager'] = 'Administrar H5P con GeniAI';
$string['h5p-manager-scorm'] = 'Administrar SCORM con GeniAI';
$string['h5p-next-step'] = 'Siguiente paso';
$string['h5p-no-apikey'] = '<p>Configurar la clave API de ChatGPT es necesario para que el sistema de creación de cuentas funcione correctamente. Esto permitirá que el sistema se comunique con ChatGPT para realizar las operaciones requeridas durante el proceso de creación de cuentas.<p><p><a href="{$a}">Haz clic aquí para configurar la clave API de ChatGPT.</a></p>';
$string['h5p-page-title'] = 'Crear un H5P con GeniAI';
$string['h5p-questionset-desc'] = 'Crea un Conjunto de Preguntas que permita a los estudiantes resolver una secuencia de preguntas diversas, incluyendo tipos como opción múltiple y verdadero/falso, ofreciendo una experiencia interactiva y desafiante.';
$string['h5p-questionset-title'] = 'Cuestionarios';
$string['h5p-readmore'] = '...más';
$string['h5p-return'] = 'Volver al Banco de Contenido';
$string['h5p-title'] = 'Administrar Banco de Contenido GeniAI';
...
$string['model'] = 'El Modelo de API';
$string['model_desc'] = 'El modelo de API que se ejecutará en OpenAI. Los valores disponibles están en el <a href="https://platform.openai.com/docs/models/overview" target="_blank">sitio web de OpenAI</a><br>
* <strong>gpt-4</strong>: Mucho más potente, ligeramente más costoso, tarda un poco más en responder y requiere un <a href="https://help.openai.com/en/articles/7102672-how-can-i-access-gpt-4" target="_blank">prepago de $1</a> para probar.<br>
...
$string['modules_desc'] = 'Esta lista contiene los módulos que no deben estar disponibles para los estudiantes, asegurando que no se usen en ejercicios.';
$string['online'] = 'En línea';
$string['pluginname'] = 'EdulabsAI';
$string['presence_penalty'] = 'Penalización de Presencia';
$string['presence_penalty_desc'] = 'Este parámetro se utiliza para alentar al modelo a incluir una variedad de tokens en el texto generado. Es un valor que se resta de la probabilidad logarítmica de un token cada vez que se genera. Un valor de penalización de presencia más alto hará que el modelo tenga más probabilidades de generar tokens que aún no se han incluido en el texto generado.';
$string['privacy:metadata'] = 'El plugin GeniAI almacena el historial de conversaciones y transmite solo el nombre completo, el nombre del curso y la URL a OpenAI, sin compartir ningún otro dato personal.';
$string['report_completion_tokens'] = 'Número de Tokens recibidos';
$string['report_datecreated'] = 'Día';
$string['report_filename'] = 'Reporte de Uso de Asistencia GPT';
$string['report_info'] = '<p>En el reporte presentado, solo están disponibles las primeras 100 líneas. Para acceder a todos los registros, por favor descarga el documento completo.</p><p>Con respecto a los tokens, una regla general es que un token corresponde aproximadamente a 4 caracteres de texto común en inglés. Esto equivale aproximadamente a ¾ de una palabra (entonces, 100 tokens ~= 75 palabras). Aprende más en la página de <a href="https://platform.openai.com/tokenizer" target="_blank">Tokenización del Modelo de Lenguaje</a>.</p>';
